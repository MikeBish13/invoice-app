...
export default function InvoiceList() {
    ...
    const filteredItems = !filter ? data : data.filter(item => item.status === filter)
    ...
    return (
        <div>
            ...
            <div className="nav-top">
                <h1>Invoices</h1>
                <ul>
                    <li><input type="checkbox" className="filter-checkbox" id="paid" onChange={(e) => setCurrentFilter(e)}></input><label htmlFor="paid">Paid</label></li>
                    <li><input type="checkbox" className="filter-checkbox" id="pending" onChange={(e) => setCurrentFilter(e)}></input><label htmlFor="pending">Pending</label></li>
                    <li><input type="checkbox" className="filter-checkbox" id="draft" onChange={(e) => setCurrentFilter(e)}></input><label htmlFor="draft">Draft</label></li>
                </ul> 
